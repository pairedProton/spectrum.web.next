...
import empower from "../../_assets/image/empowerment.png";
import impact from "../../_assets/image/impact.png";
import inovation from "../../_assets/image/inovation.png";
import sustain from "../../_assets/image/sustain.png";
import centerlogo from "../../_assets/image/centerlogo.png";
      ...
      <div className="relative  h-full">
        ...
        <div className=" hidden lg:flex  absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 ">
          <div className="bg-emerald-950 text-white  rounded-full w-40 h-40 flex justify-center items-center text-2xl relative z-30">
            <Image className="w-36 h-auto object-center object-cover" src={centerlogo} alt="" />
          </div>
        </div>
