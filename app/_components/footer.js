...
import footertext from "../_assets/images/footertext.svg";
import { FaYoutube } from "react-icons/fa";

const Footer = () => {
  return (
    <div className="w-full h-[60vh] md:h-[40vh] lg:h-[90vh] bg-emerald-950 p-5 md:p-10 pb-0 text-white flex gap-6 relative flex-col justify-start items-end overflow-hidden  ">
      ...
      <div className="w-full h-auto  flex justify-between items-start lg:mb-0 " >
        ...
        <a href="http://spectrumms.in/" target="_blank" rel="noopener noreferrer" className="border-2 border-white p-2 rounded-lg text-xl px-4 w-fit mb-4 lg:mb-6" >Login</a>

        <a href="tel:+919114040067" className="" >Contact: <br className="flex md:hidden" /> +91-9114040067</a>
        <a href="mailto:info@thespec.life" className="" >Email: <br className="flex md:hidden" /> Info@TheSpec.Life</a>
        <a href="https://maps.app.goo.gl/dUR9MPJ4dnLviHrt8" target="_blank" rel="noopener noreferrer" className="" >Address:<br className="flex md:hidden" /> Block - 2, Second Floor <br />
        ...
        <div className="flex flex-col gap-2 -mt-2" >
          <Link href="/blog" className="italic self-center mb-10 text-lg" >Blogs</Link>
          ...
          <ul className="flex flex-row gap-2 text-4xl" >
            ...
            <a href="https://www.youtube.com/channel/UCFKaB-4FHbtZgRROO9k7v-g"><FaYoutube /></a>
          </ul>
        </div>
      </div>
